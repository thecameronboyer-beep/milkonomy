import"./index-Dar2C9rJ.js";/* empty css                  *//* empty css                */import{aa as m,l as _,r as g,b as u}from"./element-BYhCvQPz.js";import{d as f,c as y,o as E,L as a,J as n,a2 as i}from"./vue-Cz8nu7m0.js";import{_ as w}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./vxe-CdmVrsGW.js";const x={lock:!0,text:"加载中..."},p=(o,e={})=>{let r;return async(...c)=>{try{return r=m.service({...x,...e}),await o(...c)}finally{r.close()}}},C={code:0,data:{list:[]},message:"获取成功"};function S(o){return new Promise(e=>{setTimeout(()=>{e({...C,data:{list:o}})},1e3)})}function v(){return new Promise((o,e)=>{setTimeout(()=>{e(new Error("发生错误"))},1e3)})}const k={class:"app-container"},A=`
  <path class="path" d="
    M 30 15
    L 28 17
    M 25.61 25.61
